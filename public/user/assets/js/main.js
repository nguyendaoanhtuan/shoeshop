$(document).ready(function(){
    ...
    $(".active-banner-slider").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:["<img src='public/user/assets/img/banner/prev.png'>","<img src='public/user/assets/img/banner/next.png'>"],
        dots:false
    });
    ...
    $(".active-product-area").owlCarousel({
        ...
        loop:true,
        nav:true,
        navText:["<img src='public/user/assets/img/product/prev.png'>","<img src='public/user/assets/img/product/next.png'>"],
        dots:false
    });
