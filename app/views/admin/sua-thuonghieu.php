            ...
            <div class="col-md-12">
                <div class="content-panel">
                    <div class="panel-body">
                        <form action="?controller=brands&action=edit&id=<?= $brand['brand_id'] ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($brand['logo_url']): ?>
                                    <div>
                                        <img src="public/<?= $brand['logo_url'] ?>" width="100" style="margin-bottom: 10px;">
                                    </div>
                                <?php else: ?>
                                    <p>Không có logo</p>
                                <?php endif; ?>
