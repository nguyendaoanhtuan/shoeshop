                    ...
                    <div class="row single-slide align-items-center d-flex">
                        ...
                        <div class="col-lg-7">
                            <div class="banner-img">
                                <img class="img-fluid" src="public/user/assets/img/banner/banner-img.png" alt="">
                            </div>
                        </div>
                    </div>
                    <!-- single-slide -->
        ...
        <div class="row features-inner">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="public/user/assets/img/features/f-icon1.png" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="public/user/assets/img/features/f-icon2.png" alt="">
                    </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="public/user/assets/img/features/f-icon3.png" alt="">
                    </div>
                    <h6>Hỗ trợ 24/7</h6>
                    <!--                    <p>Free Shipping on all order</p>-->
                </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="single-features">
                    <div class="f-icon">
                        <img src="public/user/assets/img/features/f-icon4.png" alt="">
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="single-deal">
                            ...
                            <img class="img-fluid w-100" src="public/user/assets/img/categories/gucci.jpg" alt="">
                            <a href="public/user/assets/img/category/gucci.jpg" class="img-pop-up" target="_blank">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="public/user/assets/img/categories/puma.jpg" alt="">
                            <a href="public/user/assets/img/category/c2.jpg" class="img-pop-up" target="_blank">
                                <div class="deal-details">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="public/user/assets/img/categories/Nike.jpg" alt="">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="single-deal">
                            <div class="overlay"></div>
                            <img class="img-fluid w-100" src="public/user/assets/img/categories/adidas.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-6 ">
                <div class="single-deal">
                    <div class="overlay"></div>
                    <img class="img-fluid w-100 last" src="public/user/assets/img/categories/LV-Archlight.jpg" alt="" >
    ...
    <div class="container">
        <div class="row">
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="public/user/assets/img/brand/puma.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="public/user/assets/img/brand/Adidas.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="public/user/assets/img/brand/Gucci.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="public/user/assets/img/brand/Louis-Vuitton.png" alt="">
            </a>
            <a class="col single-img" href="#">
                <img class="img-fluid d-block mx-auto" src="public/user/assets/img/brand/Nike.png" alt="">
            </a>
        </div>
    </div>
</section>
